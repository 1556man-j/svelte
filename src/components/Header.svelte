									...
									<div class="shopping-cart">
										<a href="javascript:void(0)" class="cart-count">
											<span class="cart-icon-wrap">
												...
												<span class="bigcounter" id="mobile-cart-counter">{cartCount}</span>
											</span>
										</a>
									</div>
								</div>
				...
				<div class="col">
					<div class="header-main">
						...
						<div class="header-element megamenu-content">
							<div class="mainwrap show collapse" id="main-collapse">
								<ul class="main-menu">
									<li class="menu-link">
									...
									<li class="menu-link">
										...
										<div class="menu-dropdown single-menu collapse" id="desk-blog"></div>
									</li>
									<li class="menu-link">
										<a
											href="/about"
									...
									<div class="acc-desk-header">
										...
										<div class="acc-title-lg">
											<a
												...
												on:click={() => goto('/login')}
												role="button"
												aria-label="Go to Login page"><i class="feather-user"></i></a
											>
										</div>
									</div>
								</li>
