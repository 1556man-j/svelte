            ...
            <div class="order-area">
              ...
              <div class="order-price">
                <ul class="total-order order-details">
                  <li>
                    <span class="order-no">Order no. <span id="order-no">Loading...</span></span>
                  </li>
                  <li>
                    <span class="order-date">Order date: <span id="order-date">Loading...</span></span>
                  </li>
                  <li>
                    <span class="total-price">Order Total: <span id="total-price">€0.00</span></span>
                  </li>
                </ul>
              </div>
              <!-- order-price end -->
              ...
              <div class="order-details">
                ...
                <span class="order-s"
                  >Your order will ship within few hours</span
                >
                <a href="/track-page" class="tracking-link btn btn-style"
                  >Tracking details</a
                >
              </div>
              <!-- order-details start -->
