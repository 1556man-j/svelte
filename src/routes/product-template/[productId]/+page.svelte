        ...
        <div class="row">
          <div class="col">
            <div class="pro_details_pos pro_details_left_pos">
              ...
              <div
                class="product_details_wrap product_details_tb product_details"
              >
                ...
                <div class="tab-pane" id="pro-custom-content">
                  <div class="product-custom-content">
                    <p>
                      ...
                      filler text can be very useful when the focus is meant
                      ...
                      <div class="spr-reviews">
                        ...
                        <div class="spr-review">
                          <div class="product-rating">
                            ...
                            <h3 class="spr-review-header-title">
                              Best for every time suger free
                            </h3>
                            <span class="spr-review-header-byline">
                              <strong>David smith</strong>
                              on
                          ...
                          <div class="spr-review-content">
                            <p class="spr-review-content-body">
                              he purpose of lorem ipsum is to create a natural
                              looking block of text (sentence, paragraph,
                              page, etc.) that doesn't distract from the
                              layout. A practice not without controversy,
                              laying out pages with meaningless filler text
                              can be very useful when the focus is meant to be
                ...
                <div class="tab-pane" id="product-video">
                  <div class="video">
                    <div class="video-wrapper">
                      <iframe
                        src="https://www.youtube.com/embed/0Aja_yP93PY"
                        allowfullscreen
                      ></iframe>
                    </div>
                  </div>
          ...
          <div class="col">
            <div class="product-related">
              ...
              <div class="related-slider">
                <div
                  class="product-related-slider swiper"
                  id="related-slider"
                >
      ...
      <div class="container-fluid">
        <div class="row">
          <div lang="col">
            ...
            <div
              class="insta-slider owl-carousel owl-theme"
              id="insta-slider"
            >
              <div class="item">
